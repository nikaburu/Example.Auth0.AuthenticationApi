...
namespace Example.Auth0.AuthenticationApi.AccessTokenManagement.Interfaces
{
    ...
    public interface IClientAccessTokenManagementService
    {
        ...
        Task<string> GetClientAccessTokenAsync(string clientName, ClientAccessTokenParameters parameters, CancellationToken cancellationToken);
        ...
        /// <returns>The access token or null if the no token can be requested.</returns>
        Task DeleteClientAccessTokenAsync(string clientName, ClientAccessTokenParameters parameters, CancellationToken cancellationToken);
    }
}