...
namespace Example.Auth0.AuthenticationApi.AccessTokenManagement
{
    ...
    public class ClientAccessTokenCache : IClientAccessTokenCache
    {
        ...
        /// <inheritdoc/>
        public async Task SetAsync(string clientName, string accessToken, DateTimeOffset expiration, ClientAccessTokenParameters parameters, CancellationToken cancellationToken = default)
        {
            if (clientName is null) throw new ArgumentNullException(nameof(clientName));
